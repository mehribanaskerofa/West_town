@extends('admin.layouts.admin',['title'=>'Infrastructures Type'])
@section('content')

    <?php  $routeName='admin.infrastructures-type' ?>
                        ...
                        <td>
                            <div class="form-check form-switch">
                                <input class="form-check-input flexSwitchCheckChecked" type="checkbox" role="switch"
                                       data-action="{{route('admin.status-infrastructures-type',$model->id)}}"
